...
const SquareScreen = () => {
    ...
    return <View>
        ...
        <ColorCounter title="Increment" value={increment} setValue={setIncrement} increment={1} maxValue={10} minValue={1} />
        <ColorCounter title="Red" value={red} setValue={setRed} increment={increment} />
        <ColorCounter title="Green" value={green} setValue={setGreen} increment={increment} />
        <ColorCounter title="Blue" value={blue} setValue={setBlue} increment={increment} />
