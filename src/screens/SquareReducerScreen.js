...
const reducer = (state, action) => {
  switch (action.type) {
    case actions.change_red:
      return {
        ...
        red: calcNewValue(
          ...
          MIN_COLOR_VALUE,
          MAX_COLOR_VALUE,
          action.payload * state.increment,
        ),
      }
    ...
    case actions.change_increment:
      return {
        ...state,
        increment: calcNewValue(
          state.increment,
          MIN_INCREMENT,
          MAX_INCREMENT,
          action.payload * INCREMENT_INCREMENT,
        ),
      }
    case actions.reset:
      return {
  ...
  return (
    <View>
      ...
      <ColorReducerCounter
        ...
        value={increment}
        onIncrease={() =>
          dispatch({type: actions.change_increment, payload: MODIFIER_INCREASE})
        }
        onDecrease={() =>
          dispatch({type: actions.change_increment, payload: MODIFIER_DECREASE})
        }
      />
      <ColorReducerCounter
        title="Red"
        value={red}
        onIncrease={() =>
          dispatch({type: actions.change_red, payload: MODIFIER_INCREASE})
        }
        onDecrease={() =>
          dispatch({type: actions.change_red, payload: MODIFIER_DECREASE})
        }
      />
      <ColorReducerCounter
        title="Green"
        value={green}
        onIncrease={() =>
          dispatch({type: actions.change_green, payload: MODIFIER_INCREASE})
        }
        onDecrease={() =>
          dispatch({type: actions.change_green, payload: MODIFIER_DECREASE})
        }
      />
      <ColorReducerCounter
        title="Blue"
        value={blue}
        onIncrease={() =>
          dispatch({type: actions.change_blue, payload: MODIFIER_INCREASE})
        }
        onDecrease={() =>
          dispatch({type: actions.change_blue, payload: MODIFIER_DECREASE})
        }
      />
      <View
        style={{
